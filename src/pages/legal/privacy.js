...
const ContactPage = () => (
  <Layout>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          "Us" or "Our" in this Agreement) refers to Mutual Aid New Zealand.
        </p>
      </li>
      <li>
      ...
      <li>
        <strong>Website</strong> refers to Mutual Aid New Zealand, accessible
        from https://mutualaid.org.nz
      </li>{" "}
      <li>
    ...
    <ul>
      <li>
        By visiting this page on our website: https://mutualaid.org.nz/contact
      </li>
    </ul>
  </Layout>
)
